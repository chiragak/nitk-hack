...
def cs_sidebar():
    """ Sidebar items """
    st.sidebar.markdown('<style>  .mansalva { font-family: "Mansalva", cursive; font-size: 50px; } </style>', unsafe_allow_html=True)
    st.sidebar.markdown('<div class="mansalva">SketchSync</div>', unsafe_allow_html=True)
...
def info_pics():
    ...
    st.image('/home/chirag/sketchsync/instructions_pic/draw.png')
    st.image('/home/chirag/sketchsync/instructions_pic/erase.png')
    st.image('/home/chirag/sketchsync/instructions_pic/clear.png')
    st.image('/home/chirag/sketchsync/instructions_pic/solution.png')
    st.image('/home/chirag/sketchsync/instructions_pic/bookmark.png')
